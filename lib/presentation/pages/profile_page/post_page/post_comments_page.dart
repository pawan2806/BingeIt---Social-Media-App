                            ...
                            child: NotificationListener<ScrollNotification>(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  print(_calculatePostCommentsItemCount(state));
                                  if (index == 0) {
                                  ...
                                  onPressed: () {
                                    if (_textEditingController.text.isNotEmpty) {
                                      if (isCommentReplyOrStandAlone) {
                                        ...
                                        sendit(uidOfTheCommentOwnerBeingRepliedTo, " replied to your comment");
                                      } else {
                                        context.read<UserPostBloc>().add(
                                        ...
                                        sendit(widget.postOwnerUid, " commented on your post - " + widget.postTitle);
