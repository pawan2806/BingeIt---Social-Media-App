...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  updateUserData(){
    ...
    if(_bioValid && _profileNameValid){
      ...
      SnackBar successSnackBar=SnackBar(content: Text(
          ...
          Container(
            child: Column(
              children: [
                ...
                Padding(padding: EdgeInsets.only(top: 29.0, bottom: 50.0, right: 50),
                ...
                Padding(padding: EdgeInsets.only(top: 10.0, bottom: 50.0, right: 50),
                  child: ElevatedButton(
